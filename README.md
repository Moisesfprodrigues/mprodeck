...
Aplicação desktop em Python baseada em Tkinter que simula um Stream Deck
simples, com 8 botões configuráveis que podem reproduzir sons, mostrar
imagens e executar ações via atalhos de teclado.
...
Cada botão: - Reproduz áudio assets/audio/sampleX.mp3 - Mostra imagem
assets/img/imgX.png - Usa texto assets/text/labelX.txt (se existir)

Atalhos

Teclas 1–8 ativam botões quando ligados.
